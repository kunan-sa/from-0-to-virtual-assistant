...
export const BOT_URL = "http://localhost:5005"

export const HUMAN_URL = "http://localhost:8000"

export const TO_HUMAN_TRANSFER_TEXT = "You are being transferred to a human!";

export const TO_BOT_TRANSFER_TEXT = "End";
